...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask,               xK_bracketright), namedScratchpadAction scratchpads "calc")
  , ((modMask,               xK_backslash), namedScratchpadAction scratchpads "clock")
  , ((modMask,               xK_bracketleft), namedScratchpadAction scratchpads "screen")
  , ((modMask,               xK_equal), namedScratchpadAction scratchpads "scribble")
