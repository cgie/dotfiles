...
--myLayouts = avoidStruts $ smartBorders $ OneBig (3/4) (3/4) ||| Roledex ||| tiled ||| Mirror tiled ||| simpleTabbed ||| Full
...
--  , ((modMask,               xK_backslash), namedScratchpadAction scratchpads "calc")
  , ((modMask,               xK_backslash), namedScratchpadAction scratchpads "clock")
  , ((modMask,               xK_bracketright), namedScratchpadAction scratchpads "screen")
  , ((modMask,               xK_bracketleft), namedScratchpadAction scratchpads "scribble")
